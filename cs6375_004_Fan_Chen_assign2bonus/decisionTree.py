...
class DecisionTree:
    ...
    def ID3(self, Examples, Target_Attribute, Attributes):
        ...
        # Otherwise, choose the attribute from Attributes that best* classifies Examples
            ...
            bestAttribute = self.chooseRandomAttribute(Examples, Target_Attribute, Attributes)
    ...
    def chooseRandomAttribute(self, Examples, Target_Attribute, Attributes):
        # Here is the section that choose the greatest Information Gain between parent and child
